...
from aracne.util.persistent import PriorityQueue, QueueError
...
class TestPriorityQueue(unittest.TestCase):
    ...
    def test_head(self):
        ...
        self._queue.put(0, 0)
        self.assertEquals(self._queue.head(), (0, 0))
        self._queue.put(1, 1)
        self.assertEquals(self._queue.head(), (0, 0))
    ...
    def test_tail(self):
        self.assertRaises(QueueError, self._queue.head)
        self._queue.put(0, 0)
        self.assertEquals(self._queue.tail(), (0, 0))
        self._queue.put(1, 1)
        self.assertEquals(self._queue.tail(), (1, 1))
